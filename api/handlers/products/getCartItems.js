...
module.exports = async (req, res) => {
    ...
    db.query(getUserSql, [email], (err, userResult) => {
        ...
        const getCartItemsSql = `SELECT item_name, image_filename, price, quantity, product_id FROM SHOE_PRODUCT, CART_ITEM WHERE CART_ITEM.product_id = SHOE_PRODUCT.product_id AND CART_ITEM.user_id = ?`;
